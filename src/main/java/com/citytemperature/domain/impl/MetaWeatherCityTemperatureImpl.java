...
public class MetaWeatherCityTemperatureImpl implements CityTemperature {
  ...
  public MetaWeatherCityTemperatureImpl(
      final String cityName, final LocalDate date, final BigDecimal temperatureInCelsius) {
  ...
  public BigDecimal getTemperatureInFahrenheit() {
    return withTwoDecimalPlaces(
        TemperatureConverter.convertFromCelsiusToFahrenheit(this.temperatureInCelsius));
  }
