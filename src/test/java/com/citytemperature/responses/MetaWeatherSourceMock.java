...
public enum MetaWeatherSourceMock {
    ...
    WEATHER_UNDERGROUND("Weather Underground", "wunderground", "https://www.wunderground.com/?apiref=fc30dc3cd224e19b", 720),
    WORLD_WEATHER_ONLINE("World Weather Online", "world-weather-online", "http://www.worldweatheronline.com/", 360);
    ...
    MetaWeatherSourceMock(final String title, final String slug, final String url, final Integer crawlRate) {
        this.title = title;
        this.slug = slug;
        this.url = url;
